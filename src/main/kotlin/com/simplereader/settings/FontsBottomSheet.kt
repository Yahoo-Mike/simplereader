...
import com.simplereader.databinding.ViewFontsBinding
 ...
 */
class FontsBottomSheet : BottomSheetDialogFragment() {

    private var _binding: ViewFontsBinding? = null
    ...
    companion object {
        @JvmField
        val LOG_TAG: String = FontsBottomSheet::class.java.simpleName
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = ViewFontsBinding.inflate(inflater, container, false)
        return binding.root
    }
